...
export const weekPlan: TrainingDay[] = [
  ...
  },
  {
    ...
    jiuType: "SEM JIU",
    exercises: [
      { id: "sex0", name: "Aquecimento + Mobilidade", sets: "1", reps: "8min", equipment: "Bike leve" },
      { id: "sex1", name: "Extensora Isométrica", sets: "5", reps: "30s", equipment: "Próximo da extensão" },
      { id: "sex2", name: "Mini Agachamento (parcial)", sets: "4", reps: "12", equipment: "Sem zona dolorosa" },
      { id: "sex3", name: "Leg Press Curto Unilateral", sets: "3", reps: "12", equipment: "Leve · alinhamento" },
      { id: "sex4", name: "Hip Thrust Pesado", sets: "5", reps: "8-10" },
      { id: "sex5", name: "Mesa Flexora", sets: "4", reps: "15" },
      { id: "sex6", name: "Caminhada Lateral (Glúteo Médio)", sets: "4", reps: "15/lado", equipment: "Miniband" },
      { id: "sex7", name: "Panturrilha", sets: "4", reps: "20" },
      { id: "sex8", name: "Core + Estabilidade (Pallof/Prancha)", sets: "3", reps: "30-40s" },
    ],
  },
  {
    dayIndex: 5,
